...
// Mock data for customer origin
const MOCK_ORIGIN = {
  firstVisit: "2025-03-15T10:23:00",
  utmSource: "instagram",
  utmMedium: "cpc",
  utmCampaign: "pascoa-25",
  device: "Mobile",
...
interface ClienteOriginInfoProps {
  customerId: string;
}

const ClienteOriginInfo: React.FC<ClienteOriginInfoProps> = ({ customerId }) => {
...
export default ClienteOriginInfo;
